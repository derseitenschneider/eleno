...
describe('getInvoiceUrl', function () {
    it('correctly retrieves invoice URL from Stripe Api.', function () {
        // ARRANGE
...
describe('deleteCustomer', function () {
    it('cancels all subscriptions and deletes the customer.', function () {
        // ARRANGE
...
describe('createCheckoutSession', function () {
    it('creates and returns a stripe checkout session.', function () {
        // ARRANGE
...
describe('createCustomerPortal', function () {
    it('creates and returns a customer portal session.', function () {
        // ARRANGE
        $customerId = 'customer-id';
...
describe('cancelAtPeriodEnd', function () {
...
describe('handleReactivation', function () {
    it('handles reactivating the user', function () {
        // ARRANGE
        $subscriptionId = 'subscription-id';
        $userId         = 'user-id';
        $firstName      = 'first-name';
