...
This file provides guidance to CLAUDE CODE agent when working with code in this repository.
...
- `npm run biome check` - Runs formatter, linter and import sorting to the requested files
- `npm run biome check --write` - Runs check and applies safe fixes, formatting and import sorting
