  ...
  return (
    <div className="terms">
      ...
      <p>
        ...
        BUGS, MANIPULATIONEN, BETRUG, FEHLER, AUSLASSUNGEN, UNTERBRECHUNGEN,
        DEFEKTE, VERZÖGERUNGEN BETRIEBS- ODER ÜBERTRAGUNGSFEHLER,
        COMPUTERLEITUNGS- ODER NETZWERKFEHLER ODER ANDERE TECHNISCHE ODER
        SONSTIGE FEHLFUNKTIONEN, EINSCHLIESSLICH, OHNE EINSCHRÄNKUNG,
        SCHADENSERSATZ FÜR ENTGANGENEN GEWINN, GESCHÄFTSVERLUST, DATENVERLUST,
        ARBEITSUNTERBRECHUNG, GENAUIGKEIT DER ERGEBNISSE ODER COMPUTERAUSFALL
        ODER FEHLFUNKTION, SELBST WENN VORHERSEHBAR ODER SELBST WENN DIE
        ELENO-PARTEIEN AUF DIE MÖGLICHKEIT SOLCHER SCHÄDEN HINGEWIESEN WURDEN
        ODER HÄTTEN WISSEN MÜSSEN, OB AUF VERTRAGSHANDLUNG, FAHRLÄSSIGKEIT,
        GEFAHRENHAFTIGE HAFTUNG ODER DELIKT (EINSCHLIESSLICH, OHNE
        EINSCHRÄNKUNG, OB GANZ ODER TEILWEISE DURCH FAHRLÄSSIGKEIT VERURSACHT,
        HÖHERE GEWALT, AUSFALL DER TELEKOMMUNIKATION ODER DIEBSTAHL ODER
        ZERSTÖRUNG DES DIENSTES). IN KEINEM FALL HAFTEN DIE ELENO-PARTEIEN IHNEN
        ODER ANDEREN GEGENÜBER FÜR VERLUSTE, SCHÄDEN ODER VERLETZUNGEN,
        EINSCHLIESSLICH, OHNE EINSCHRÄNKUNG, TOD ODER PERSONENSCHÄDEN. EINIGE
        STAATEN LASSEN DEN AUSSCHLUSS ODER DIE BESCHRÄNKUNG VON ZUFÄLLIGEN ODER
        FOLGESCHÄDEN NICHT ZU, SO DASS DIE OBEN GENANNTE EINSCHRÄNKUNG ODER DER
        AUSSCHLUSS MÖGLICHERWEISE NICHT FÜR SIE ZUTRIFFT. IN KEINEM FALL
        ÜBERSTEIGT DIE GESAMTHAFTUNG DER ELENO-PARTEIEN IHNEN GEGENÜBER FÜR ALLE
        SCHÄDEN, VERLUSTE ODER URSACHEN ODER MASSNAHMEN EINHUNDERT US-DOLLAR
        (100,00 $).
      </p>
      <p>
