...
CREATE OR REPLACE VIEW "public"."lesson_years" WITH ("security_invoker"='true') AS
 SELECT "lessons"."studentId",
    "array_agg"(DISTINCT EXTRACT(year FROM "lessons"."date") ORDER BY (EXTRACT(year FROM "lessons"."date")) DESC) AS "years"
   FROM "public"."lessons"
  GROUP BY "lessons"."studentId";

ALTER TABLE "public"."lesson_years" OWNER TO "postgres";
...
GRANT ALL ON TABLE "public"."lesson_years" TO "anon";
GRANT ALL ON TABLE "public"."lesson_years" TO "authenticated";
GRANT ALL ON TABLE "public"."lesson_years" TO "service_role";
