...
test('create lesson is blocked', async ({ forwardOneMonth }, testInfos) => {
...
test('create note is blocked', async ({ forwardOneMonth }, testInfos) => {
  const lessonPom = new LessonsPOM(forwardOneMonth, testInfos)
...
test('create repertoire item is blocked', async ({
  forwardOneMonth,
}, testInfos) => {
...
test('create todo is blocked', async ({ forwardOneMonth }, testInfos) => {
