  ...
  if (isButton)
    return (
      <li className='h-full w-full p-2'>
        <button
          className='align-center z-1 w-full relative flex items-center gap-4 p-1.5 text-foreground before:absolute before:left-0 before:top-0 before:z-[-1] before:h-full before:w-full before:rounded-md before:hidden after:absolute after:left-0 after:top-0 after:z-[-1] after:h-full after:w-full after:rounded-md after:bg-transparent hover:no-underline hover:after:bg-background100'
          type='button'
          onClick={() => onClick?.()}
        >
