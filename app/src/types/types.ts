...
// This type is for creating a lesson only since the omitted types are
...
// Removing null from generated types except for certain fields
export type Student = DBTypes["students"]

// This type is for creating a lesson only since the omitted types are
// automatically generated by supabase.
export type StudentPartial = Omit<Student, "id" | "created_at">
