...
// Type for active notes (from view) which can be used interchangeably with Note in most contexts
// The view omits created_at but has all other fields
export type ActiveNote = Omit<Note, 'created_at'>
