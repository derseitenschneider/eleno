...
export type TodoItem = TodoItemWithGroupId | TodoItemWithStudentId

// This type is only for creating a repertoire item since the omitted types are
// automatically generated by supabase.
export type PartialTodoItem = Omit<TodoItem, 'id' | 'user_id' | 'created_at'>
