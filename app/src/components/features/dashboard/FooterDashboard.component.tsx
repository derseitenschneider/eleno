...
function FooterDashboard() {
  return (
    <footer className='border-t border-hairline col-start-1 gap-1 flex col-end-3 flex-col md:flex-row justify-center md:gap-4 flex-wrap text-[10px] !py-4 px-5 md:px-8'>
      <Link
