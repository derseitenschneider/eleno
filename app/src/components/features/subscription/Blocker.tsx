...
export function Blocker({ variant = 'block', blockerId = '' }: BlockerProps) {
  ...
  if (variant === 'inline')
    return (
      ...
      >
        <div className='mx-auto mt-[-10px] flex w-fit items-center gap-4 rounded-sm border border-hairline bg-background100 p-2 px-4 shadow-sm'>
  ...
  return (
    ...
    >
      <Card className='flex flex-col items-center justify-center p-5 shadow-sm'>
