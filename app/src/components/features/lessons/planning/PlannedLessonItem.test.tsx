...
import { createMockStudent, createMockGroup, createMockLesson } from '@/test/factories'
...
vi.mock('./PlannedLessonDropdown.component', () => ({
  default: ({ insertLesson, lessonId }: any) => (
    <div data-testid="prepare-lesson-dropdown">
      <button
        data-testid="dropdown-insert-lesson"
...
describe('PreparedLessonItem', () => {
  ...
  describe('Insert Lesson Functionality', () => {
    ...
    it('inserts lesson into drafts for group', async () => {
      ...
      renderWithProviders(
        <PreparedLessonItem currentLesson={groupLesson} onClose={mockOnClose} />
      )
  ...
  describe('Dropdown Integration', () => {
    it('passes correct lesson ID to dropdown', () => {
      ...
      expect(screen.getByTestId('dropdown-lesson-id')).toHaveTextContent('lesson-1')
    })
  ...
  describe('Content Sanitization', () => {
    it('sanitizes HTML content in lesson content', () => {
      ...
      renderWithProviders(
        <PreparedLessonItem currentLesson={lessonWithHTML} />
      )
    ...
    it('handles null lesson content gracefully', () => {
      ...
      renderWithProviders(
        <PreparedLessonItem currentLesson={lessonWithNull} />
      )
  ...
  describe('Edge Cases', () => {
    ...
    it('handles future dates correctly', () => {
      ...
      renderWithProviders(
        <PreparedLessonItem currentLesson={futureLessen} />
      )
    ...
    it('handles past dates correctly', () => {
      ...
      renderWithProviders(
        <PreparedLessonItem currentLesson={pastLesson} />
      )
